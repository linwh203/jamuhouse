<template>
  <div class="home">
    ...
    <div class="section">
      <img src="../assets/course2-bg.png" alt="">
      <div class="btn-1" @click="goPage('course2-1')"><img src="../assets/course-btn.png" alt=""></div>
      <div class="btn-2" @click="goPage('course2-2')"><img src="../assets/course-btn.png" alt=""></div>
    </div>
  </div>
</template>
